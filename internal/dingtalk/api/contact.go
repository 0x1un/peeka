...
// 		Cache.Set(v.Name, []byte(v.Userid))
// 	}
// 	err := ioutil.WriteFile(filename, buffer.Bytes(), 0666)
// 	if err != nil {
// 		return err
// 	}
// 	if entry, err := Cache.Get("张军"); err == nil {
...
//
// // 从cache文件中读取用户信息
// func (c *UsersOfDepartment) ReadFromCacheFile() (map[string]string, error) {
// 	if !misc.IsExist(".users") {
// 		return nil, errors.New(".users文件没有找到")
// 	}
